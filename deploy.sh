fission spec init
fission env create --spec --name onb-br-enum-marit-env --image nexus.sigame.com.br/fission-onboarding-br-enum-marit:0.1.0 --poolsize 0 --version 3 --imagepullsecret "nexus-v3" --spec
